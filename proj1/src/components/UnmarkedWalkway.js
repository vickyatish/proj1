...
const UnmarkedWalkway = ({ onCitationClick }) => { // Accept onCitationClick as a prop
  return (
    <div className="unmarked-walkway">
      ...
      <ul>
          <li><strong>Technology:</strong> Hough Transform, canny edge detection <button className="citation-button" onClick={() => onCitationClick(11)}>[11]</button>, and deep learning models like LaneNet are commonly used techniques for lane and edge detection.</li>
      ...
      <ul>
          <li><strong>Technology:</strong> LiDAR and camera-based sensor fusion <button className="citation-button" onClick={() => onCitationClick(12)}>[12]</button> can be used for 3D environmental mapping.</li>
